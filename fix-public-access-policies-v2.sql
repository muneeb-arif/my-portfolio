...
-- Version 2: Works with existing is_portfolio_owner function
...
-- Test if is_portfolio_owner function works (replace with actual user_id for testing)
-- SELECT 
--   'Test is_portfolio_owner function' as test,
--   is_portfolio_owner('YOUR_USER_ID_HERE') as result;
